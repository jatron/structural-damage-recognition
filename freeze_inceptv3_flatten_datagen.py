...
checkpoint_path = "training/cp-freeze_layers_incept3_flatten_datagen-{epoch:04d}.ckpt"
...
pickle.dump(history.history, open("history_freeze_layers_incept3_flatten_datagen.pkl", "wb"))
